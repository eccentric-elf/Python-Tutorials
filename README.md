...
8.	Given a file “auto.csv” of automobile data with the fields index, company, body-style, wheel-base, length, engine-type, num-of-cylinders, horsepower average-mileage, and price, write Python codes using Pandas to
...
10.	Create a stud.csv file containing rollno, name, place and mark of students. Use
...
11.	Given the sales information of a company as CSV file with the following fields
...
16.	Write a python program to create two numpy arrays of random integers between 0 and 20 of shape (3, 3) and perform matrix addition, multiplication and transpose of the
product matrix.
